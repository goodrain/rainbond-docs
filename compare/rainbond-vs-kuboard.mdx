...
description: 如果你更关注应用交付和低 K8s 门槛，Rainbond 更适合；如果你更关注 Kubernetes 管理界面，Kuboard 更合适。
hide_title: true
...
<Head>
  ...
  <meta
    ...
    content="如果你更关注应用交付和低 K8s 门槛，Rainbond 更适合；如果你更关注 Kubernetes 管理界面，Kuboard 更合适。"
  />
