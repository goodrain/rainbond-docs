...
部署GlusterFS存储节点，请参见 [GlusterFS双机复制集群安装](../operation-manual/storage/GlusterFS/install.html)

#### NAS

对接阿里云文件存储NAS，请参见[对接文件存储NAS](../operation-manual/storage/nas/alinas-install.html)
