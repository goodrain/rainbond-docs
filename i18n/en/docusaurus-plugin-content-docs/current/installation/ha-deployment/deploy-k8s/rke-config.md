...
description: 'RKE Cluster Configuration Parameter Description, how to change the RKE cluster configuration '
keywords:
- RKE集群配置
---
...
进入企业视图 **集群 -> 添加集群/集群配置 -> 自定义配置** 进行 RKE Kubernetes 集群参数配置。[更多请参阅 RKE 官方文档](https://docs.rancher.cn/docs/rke/example-yamls/_index)。

<details>
  <summary>RKE 集群配置参数示例</summary>
  <div>
