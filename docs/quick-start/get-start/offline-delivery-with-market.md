...
- 开发环境安装 Rainbond 进行在线开发，并且将开发的业务系统发布成为应用模版。本文档以 [将应用发布为应用模版](/docs/quick-start/get-start/release-to-market/) 中发布出来的应用模版为例。
...
接下来，参照 [从应用市场部署一个应用](/docs/quick-start/get-start/create-app-from-market/) 的操作，即可将应用模版安装到生产环境中。
...
- 已有应用的升级，参考 [应用模版的升级](/docs/quick-start/get-start/upgrade-from-market/)。
