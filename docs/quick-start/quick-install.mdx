...
当前安装方式可以仅通过运行一个容器快速体验到 Rainbond 完整功能。该版本为单机体验版，仅适用于体验 Rainbond 功能或者个人开发环境。支持 `Windows(x86_64)`、`Mac(Intel/M1)`、`Linux(x86_64,arm64)`。该安装方式需要机器上 `80、443、6060、6443、7070、8443` 端口可用。
