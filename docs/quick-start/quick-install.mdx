...
- 对 Rainbond 已经有一定了解，但是对 Kubernetes 集群不熟悉的用户，我们推荐你选择[Web界面安装](/docs/installation/install-with-ui/)
...
### [基于 Web 界面安装](/docs/installation/install-with-ui/)
...
### [基于自建 Kubernetes 集群安装](/docs/installation/install-with-helm/)
