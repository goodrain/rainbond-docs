...
```shell
docker pull rainbond/rainbond:v5.8.0-dind-allinone
docker save -o rainbond-v5.8.0-dind-allinone.tar rainbond/rainbond:v5.8.0-dind-allinone
```

导入 tar 包到目标服务器中。

```shell
docker load -i rainbond-v5.8.0-dind-allinone.tar
```
...
-e EIP=$EIP \
rainbond/rainbond:v5.8.0-dind-allinone \
