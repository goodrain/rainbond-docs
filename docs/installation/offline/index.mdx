...
```shell
docker pull rainbond/rainbond:v5.10.0-dind-allinone
docker save -o rainbond-v5.10.0-dind-allinone.tar rainbond/rainbond:v5.10.0-dind-allinone
```
...
-e EIP=$EIP \
rainbond/rainbond:v5.10.0-dind-allinone \
...
```shell
docker pull rainbond/rainbond:v5.10.0-arm64-dind-allinone
docker save -o rainbond-v5.10.0-arm64-dind-allinone.tar rainbond/rainbond:v5.10.0-arm64-dind-allinone
```
...
-v /opt/rainbond:/opt/rainbond \
-e EIP=$EIP \
rainbond/rainbond:v5.10.0-arm64-dind-allinone \
&& docker logs -f rainbond-allinone
```
