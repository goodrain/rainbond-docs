...
对接阿里云盘存储到 Rainbond 平台可参考 [Rainbond 平台对接阿里云盘](ops-guide/storage/ali-disk/)

对接 ceph 块存储到 Rainbond 平台可参考 [Rainbond 平台对接 ceph-rbd 块存储](installation/ha-deployment/storage/ceph-rbd)
