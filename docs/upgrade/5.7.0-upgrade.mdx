...
[5.7.0 版本变更](/docs/community/change/5.6.0-5.7.0)
...
```bash
helm upgrade --set Component.rbd_app_ui.image=registry.cn-hangzhou.aliyuncs.com/goodrain/rainbond:v5.7.0-release-allinone --set operator.image.tag=v5.7.0-release --set Cluster.installVersion=v5.7.0-release rainbond rainbond/rainbond-cluster
```
