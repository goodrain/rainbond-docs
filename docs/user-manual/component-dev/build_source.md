...
Rainbond 组件创建有三种模式：[源码](/docs/user-manual/component-create/language-support/)、[镜像](/docs/user-manual/component-create/image-support/)和应用市场，不同的创建方式对应组件不同的构建源类型。 对于开发者来说可能需要经常修改代码分支、镜像 Tag，构建环境参数等。这些需求通过对组件构建源的相关设置完成。
