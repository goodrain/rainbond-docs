...
- 在新搭建 Rainbond 环境中安装 [grctl](ops-guide/tools/grctl) 工具。
...
- [控制台高可用](installation/ha-deployment/console-recover): 将单机版的控制台也迁移到集群中部署。
- [高可用部署](installation/ha-deployment/): 部署一个高可用集群用于生产环境。
