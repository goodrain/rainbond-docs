...
该版本通过主机安装的时候，如果所有节点公网ip检测全部通过，则会直接去安装k8s集群，如果有节点链接失败，可以再去失败的节点配[配置免密登陆](https://rainbond.com/docs/troubleshooting/installation/ui#cluster-must-have-at-least-one-etcd-plane-host)。或者移除链接失败的节点。
