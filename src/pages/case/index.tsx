...
export default function usescene() {
  ...
  const Header = {
    title: "用户案例",
    description: "Rainbond 深受数千家企业的信任，这些案例内容已同步归档到 Blog 的“客户案例”分类中。"
  };
