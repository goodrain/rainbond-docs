                ...
                <div className="rainbond_box">
                    ...
                    <header>
                        <div className="rainbond_helmTop">
                            <div className="rainbond_heard">TKE 安装命令生成工具</div>
                        </div>
                    </header>
                    {/* 中间内容 */}
                        ...
                        <Form onFinish={this.onFinish}>
                            ...
                            <div className="rainbond_lines">
                                ...
                                <div className="rainbond_has">
                                    <Form.Item
                                        ...
                                        extra={<div style={{width: '780px'}}>rainbond网关安装到的节点，可以安装到多个节点，实现网关高可用,节点名称填写是k8s集群中node名称。</div>}
                                        rules={[
                                            { required: true, message: '内容不能为空' }
                                        ]}
                                    >
                            ...
                            <div className="rainbond_storage">
                                <div className="rainbond_handelTitle">
                                    <div>
                                        <h4 className="rainbond_titles">CFS 存储:</h4>
                                    </div>
                                    <div className='descs'>
                                ...
                                <div className="rainbond_ha">
                                    <div className="rainbond_rowsLefts">
                                        <div className="rainbond_rows_rwxs">
                                            ...
                                            >
                                                <Input className="rainbond_inputs" placeholder="请输入挂载点地址  例：192.168.0.12" />
                                            </Form.Item>
                                        </div>
                                        <div className="rainbond_rows">
                                            <span className="rainbond_spanTitles">挂载点路径</span>
                                            <Form.Item
                                                name="path"
                                            >
                                                <Input className="rainbond_inputs" placeholder="请输入挂载点路径  例：/" />
                                            </Form.Item>
                                        </div>
                                    </div>
                                </div>
