...
export default function Index(props) {
    ...
    const handleLanguageChange = (newLocale) => {
        ...
        // 更新本地存储
        console.log("use locale", useLocale, "new locale", newLocale, "currentLocale", currentLocale, "location.pathname", location.pathname);
