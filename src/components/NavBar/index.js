        ...
        <nav className={`${styles.nav_bar} ${styles.width}`}>
          ...
          <div className={styles.nav_container}>
            <ul className={styles.nav_lists}>
                ...
                <div className="dropdown dropdown--hoverable">
                  ...
                  <ul className="dropdown__menu">
                    <li>
                      <Link
                        to="/xinchuang"
                        className={clsx('dropdown__link', styles.DropDownFont)}
                      >
                        <Translate id="navbar.xinchuang">信创</Translate>
                      </Link>
                    </li>
                    <li>
                      <Link
                  ...
                  <ul className="dropdown__menu">
                    <li>
                      <Link
                        ...
                        className={clsx('dropdown__link', styles.DropDownFont)}
                      >
                        <Translate id="navbar.usescene">使用场景</Translate>
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        className={clsx('dropdown__link', styles.DropDownFont)}
                      >
                        <Translate id="navbar.case">用户案例</Translate>
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        className={clsx('dropdown__link', styles.DropDownFont)}
                      >
                        <Translate id="navbar.blog">博客</Translate>
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        className={clsx('dropdown__link', styles.DropDownFont)}
                      >
                        <Translate id="navbar.intro">OpenAPI</Translate>
                      </Link>
                    </li>
                  </ul>
                </div>
              ...
              <li>
                <Link to="/marketplace">
                  <Translate id="navbar.market">应用商店</Translate>
                </Link>
              </li>
              <li>
                <a
