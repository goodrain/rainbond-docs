...
storage:
  ...
  },
  {
    ...
    summary: '了解如何把 RainSkills 接入 Codex 或 Claude Code，让 AI 从生成代码继续完成 Rainbond 部署、排错、交付验证和访问确认。',
    category: 'AI 部署',
    difficulty: '功能介绍',
    duration: '01:46',
    operationTime: '10 分钟',
    ...
    steps: [
      {
        ...
        title: '安装 RainSkills',
        duration: '',
        description: '当前推荐使用 npx 安装 RainSkills，把 Rainbond 部署能力接入本机 AI 编码工具；CDN 命令作为 Node.js 不可用时的兜底方式。',
        bullets: [
          '在本机终端中通过 npx 启动 RainSkills 官方安装器。',
          '等待安装流程写入对应的 Skills 配置。',
          '没有 Node.js、Node.js 低于 18 或 npm registry 不可用时，再使用 CDN 安装入口。',
        ],
