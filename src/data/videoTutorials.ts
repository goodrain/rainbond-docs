...
storage:
  ...
  },
  {
    ...
    title: 'RainSkills 安装与连接',
    summary: '了解如何通过 AI Agent 对话或命令行安装 RainSkills、选择应用运行环境，并通过浏览器完成授权连接。',
    category: 'AI 工具',
    difficulty: '入门',
    duration: '',
    operationTime: '5 分钟',
    audience: '准备在 Codex、Claude Code 等 AI Agent 中安装 RainSkills 并连接应用运行环境的开发者',
    cover: '/img/video/rainskills-ai-deploy-cover.jpg',
    bvid: 'BV1TxG46WE3L',
    tags: ['RainSkills', '安装教程', '运行环境', '浏览器授权', 'Codex', 'Claude Code'],
    ...
    steps: [
      {
        ...
        title: '安装 RainSkills',
        duration: '',
        description: '可以直接让 AI Agent 完成安装，也可以在终端运行官方安装器，两种方式任选其一。',
        bullets: [
          '使用 Codex、Claude Code 等受支持的 Agent 时，可以直接发送安装请求。',
          '习惯使用终端时，可以运行 npx 安装命令。',
          '选择其中一种方式，保持当前任务或终端运行，等待安装完成。',
          '看到“Rainskills 安装完成，下一条消息即可直接使用”后，继续连接应用运行环境。',
        ],
        commands: [
          {
            title: '对 Agent 说',
            command: '帮我安装 RainSkills',
          },
          {
            title: 'Node.js 18+ 命令行安装',
            command: 'npx --yes rainskills',
          },
        ],
        image: '/img/video/rainskills-step-1.png',
        imageAlt: 'RainSkills 在 AI Agent 中安装完成的截图',
        imageCaption: 'RainSkills 安装完成',
        timestamp: '',
      },
      {
        label: '',
        title: '连接并选择应用运行环境',
        duration: '',
        description: '安装完成后，让 Agent 连接应用运行环境，再选择云端、本机、独立服务器或已有 Rainbond。',
        bullets: [
          '继续在当前 Agent 任务中发送下面的连接请求。',
          '没有可用环境时，RainSkills 会直接显示运行环境选项。',
          '希望快速开始时，可以选择云端环境。',
          '希望使用自己的基础设施时，可以选择本机、独立服务器或已有 Rainbond。',
          '本教程以云端环境为例继续完成连接。',
        ],
        commandTitle: '对 Agent 说',
        command: '帮我连接应用运行环境',
        image: '/img/video/rainskills-step-2.png',
        imageAlt: 'RainSkills 选择云端本机服务器或已有 Rainbond 运行环境的截图',
        imageCaption: '选择应用运行环境',
        timestamp: '',
      },
      {
        label: '',
        title: '在浏览器中确认授权',
        duration: '',
        description: '选择云端或已有 Rainbond 后，按照浏览器页面提示完成账号授权。',
        bullets: [
          '在自动打开的浏览器页面中登录并确认授权。',
          '不需要在聊天中粘贴 Token、JWT、密码或私钥。',
          '授权完成后回到 Agent，继续等待原连接过程结束。',
        ],
        image: '/img/video/rainskills-step-3.png',
        imageAlt: 'RainSkills 在浏览器中完成运行环境授权的截图',
        imageCaption: '在浏览器中完成授权',
        timestamp: '',
      },
      {
        label: '',
        title: '确认运行环境连接成功',
        duration: '',
        description: 'Agent 明确返回连接成功后，RainSkills 才完成首次使用前的环境准备。',
        bullets: [
          '浏览器显示授权成功后，不要重复发起连接。',
          '回到原 Agent 任务，等待它明确返回运行环境连接成功。',
          '连接完成后，后续部署、查询和排错可以直接复用当前环境。',
        ],
        image: '/img/video/rainskills-step-4.png',
        imageAlt: 'RainSkills 运行环境连接成功提示的截图',
        imageCaption: '确认运行环境连接成功',
        timestamp: '',
      },
    ],
  },
