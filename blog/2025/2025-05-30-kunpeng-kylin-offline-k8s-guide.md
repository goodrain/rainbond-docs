...
description: Rainbond V6 国产化部署教程，针对鲲鹏 CPU + 麒麟 V10 的离线环境，手把手教你从环境准备到应用上线，所有依赖包提前打包好，步骤写成傻瓜式操作指南。别说技术团队了，照着文档一步步来，让你领导来都能独立完成部署。
...
> 如果你不是只想看单篇教程，而是想先判断“纯离线安装、鲲鹏 / 麒麟部署、x86 到 ARM 迁移、信创平台能力”之间的关系，建议进入 [离线 / 信创 / 国产化专题](/offline-and-xinchuang)，当前这篇对应的是 [鲲鹏 / 麒麟部署子页](/offline-and-xinchuang/kunpeng-kylin-deploy)。
