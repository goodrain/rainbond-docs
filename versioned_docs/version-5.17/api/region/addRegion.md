...
|» desc|body|string| 否 ||备注|
|» httpdomain|body|string| 是 ||none|
|» key_file|body|string| 否 ||none|
|» region_alias|body|string| 是 ||集群别名|
|» region_name|body|string| 是 ||集群ID|
...
|状态码|状态码含义|说明|数据模型|
|---|---|---|---|
|201|[Created](https://tools.ietf.org/html/rfc7231#section-6.3.2)|成功|[RegionInfo](#regioninfo)|
