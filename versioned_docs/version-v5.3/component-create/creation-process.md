...
2. 等待 Rainbond 对源代码进行检测，这个过程 Rainbond 将根据代码源信息获取源代码并进行语言类型、语言规范等检测，并从 [Rainbondfile](../component-create/language_support/rainbondfile) 文件中读取组件属性。
...
5. 组件构建完成后即可通过端口绑定的默认域名进行访问。后续的管理维护流程参阅 [组件开发](../user-manual/component-dev/app_copy/) [组件运维](../user-manual/component-op/custom-monitor/)
...
[Java 语言参考](./language_support/java/java-maven/)  
[PHP 语言参考](./language_support/php)  
[Python 语言参考](./language_support/python)  
[NodeJS 语言参考](./language_support/nodejs)  
[.Net 语言参考](./language_support/netcore)  
[Html 语言参考](./language_support/html)  
[定义 Dockerfile 的任意源代码参考](./language_support/Dockfile/)
...
4. 构建完成后即可访问组件。后续的管理维护流程参阅 后续的管理维护流程参阅 [组件开发](../user-manual/component-dev/auto_build/) [组件运维](../user-manual/component-op/custom-monitor/)
