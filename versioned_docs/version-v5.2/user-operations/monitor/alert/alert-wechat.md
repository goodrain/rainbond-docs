...
集群监控报警部署请参见 [集群监控报警部署](../user-operations/monitor/monitor-alert-deploy/)
...
<image src="https://grstatic.oss-cn-shanghai.aliyuncs.com/images/docs/5.2/user-operations/monitor/alert/alert-wechat-env.png" width="100%" />
