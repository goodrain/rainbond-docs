...
在安装 Rainbond 之前，需要一个 `1.13` 及以上版本的高可用 Kubernetes。请参考 [Kubernetes 的高可用安装](../user-operations/install/kubernetes-install/#kubernetes的高可用安装)。

## 基于已有 Kubernetes 安装高可用 Rainbond 环境


接下来的安装步骤，参见 [基于 K8s 高可用安装](../install/install-from-k8s/high-availability/)。