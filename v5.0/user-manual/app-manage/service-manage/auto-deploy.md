...
- 开启自动部署后，每次提交代码的Commit信息中必须包含触发自动部署关键字、例如：  `@deploy` 才能触发自动构建
...
### 3.1 开启自动部署
  ...
  <center><img src="https://grstatic.oss-cn-shanghai.aliyuncs.com/images/docs/5.0/user-manual/1548422517293.jpg" style="border:1px solid #eee;width:100%"/></center>
...
请参考如下截图:
<center><img src="https://grstatic.oss-cn-shanghai.aliyuncs.com/images/docs/5.0/user-manual/1548411288653.jpg" style="border:1px solid #eee;width:100%"/></center>

<center><img src="https://grstatic.oss-cn-shanghai.aliyuncs.com/images/docs/5.0/user-manual/1548411371103.jpg" style="border:1px solid #eee;width:100%"/></center>