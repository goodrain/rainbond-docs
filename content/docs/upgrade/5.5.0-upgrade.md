...
[5.4.1 版本变更](/docs/community/change/5.4.0-5.5.0/)
...
1. 数据中心端升级
   ...
   1. 更新 grctl 命令
      ...
      **注意：**如果遇到无法安装 grctl 可以[参考grctl安装文档](https://www.rainbond.com/docs/user-operations/tools/grctl/)
...
2. 插件升级
   ...
   1. 获取镜像并推送到私有仓库
      ...
      docker pull registry.cn-hangzhou.aliyuncs.com/goodrain/rbd-init-node:v5.5.0-release
      docker tag registry.cn-hangzhou.aliyuncs.com/goodrain/rbd-init-node:v5.5.0-release goodrain.me/rbd-init-node:latest
      docker push goodrain.me/rbd-init-node:latest
      ```
