...
* 基于A/B测试的实践
  ...
  A/B测试策略本身就是灰度发布的一种实践，在继续下文之前，请务必阅读并掌握  [A/B测试实践](/docs/advanced-scenarios/devops/ab-released-app/)
...
* 外部服务
  ...
  依然通过 [应用网关](/docs/user-manual/gateway/gateway/) -> [访问策略](/docs/user-manual/gateway/traffic-control/) 添加以下两个HTTP访问策略：
