...
* 准备域名对应的证书（如果你可以准备）
* Rainbond平台已安装完成，参考文档[Rainbond快速安装](</docs/user-operations/install/online_install/>)
...
我们采用基于DockerRun命令的方式创建组件，参考文档 [基于镜像创建组件]([/docs/user-manual/app-creation/service_create/#从docker镜像创建](/docs/user-manual/app-creation/service_create/#%E4%BB%8Edocker%E9%95%9C%E5%83%8F%E5%88%9B%E5%BB%BA)) ,
