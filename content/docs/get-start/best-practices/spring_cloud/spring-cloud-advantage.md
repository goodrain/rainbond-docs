...
> 了解服务管理的详情，请参见文档： [服务组件管理](/docs/user-manual/component-op/)
...
> 了解性能监控的详情，请参见文档： [性能监控](/docs/user-manual/plugin-manage/tcm-plugin/)
...
> 了解应用市场详情，请参见文档：[共享库](/docs/enterprise-manager/enterprise/appcenter/)
